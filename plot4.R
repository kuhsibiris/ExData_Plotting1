...
plot(energydata2$TotDate,energydata2$Global_active_power,col="white", ylab= "Global active power",xlab="")
lines(energydata2$TotDate,energydata2$Global_active_power)

plot(energydata2$TotDate,energydata2$Voltage,col="white", ylab= "Voltage",xlab="datetime")
lines(energydata2$TotDate,energydata2$Voltage)


plot(energydata2$TotDate,energydata2$Sub_metering_1,col="white", ylab= "Energy Sub Metering",xlab="")
...
plot(energydata2$TotDate,energydata2$Global_reactive_power,col="white", ylab="Global_reactive_power", xlab= "datetime")
lines(energydata2$TotDate,energydata2$Global_reactive_power)
